...
namespace GooglePlayGames
{
    ...
    public static class GameInfo
    {
        ...
        // ap setting these to invalid to disable the way in which these variables get set. 
        // we want to set this at runtime from the outside. 
        public static string ApplicationId = "INVALID"; // Filled in automatically
        public static string WebClientId = "INVALID"; // Filled in automatically
